...
var IdealProviderService = /*#__PURE__*/function (_PaymentService) {
  _inherits(IdealProviderService, _PaymentService);

  var _super = _createSuper(IdealProviderService);

  function IdealProviderService(_ref, options) {
    var _this;
  ...
  _createClass(IdealProviderService, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.stripeProviderService_.getStatus(paymentData);
    ...
    value: function () {
      var _createPayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(cart) {
        var _cart$context$payment, _cart$context, _this$options_;
