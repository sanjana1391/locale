...
var ReturnService = /** @class */ (function (_super) {
    ...
    ReturnService.prototype.list = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                returnRepo = this.manager_.getCustomRepository(this.returnRepository_);
                query = (0, utils_1.buildQuery)(selector, config);
                return [2 /*return*/, returnRepo.find(query)];
            });
        });
    };
    /**
    ...
    ReturnService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var returnRepository, orderId, _a, _b, item, line, e_4_1, order, returnLines, toRefund, refundable, method, returnObject, returnReasons, rItemRepo, created, result, shippingMethod_1, calculationContext, taxLines, shippingTotal;
                            var e_4, _c;
                            var _d, _e, _f, _g, _h;
                                ...
                                switch (_j.label) {
                                    ...
                                    case 17:
                                        ...
                                        return [4 /*yield*/, this.taxProviderService_
                                                .withTransaction(manager)
                                                .createShippingTaxLines(shippingMethod_1, calculationContext)];
                                    case 18:
                                        taxLines = _j.sent();
                                        shippingTotal = shippingMethod_1.price +
                                            taxLines.reduce(function (acc, tl) {
                                                return acc + Math.round(shippingMethod_1.price * (tl.rate / 100));
                                            }, 0);
