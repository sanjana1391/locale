...
declare class PriceListImportStrategy extends AbstractBatchJobStrategy {
     ...
     */
    protected uploadImportOpsFile(batchJobId: string, results: Record<OperationType, PriceListImportOperation[]>): Promise<void>;
    /**
     ...
     */
    protected downloadImportOpsFile(batchJobId: string, op: OperationType): Promise<PriceListImportOperation[]>;
    /**
