...
var FulfillmentProviderService = /** @class */ (function (_super) {
    ...
    function FulfillmentProviderService(container) {
        ...
        var manager = container.manager, fulfillmentProviderRepository = container.fulfillmentProviderRepository;
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        fulfillmentProviderRepo = manager.getCustomRepository(this.fulfillmentProviderRepository_);
    ...
    FulfillmentProviderService.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fpRepo = this.manager_.getCustomRepository(this.fulfillmentProviderRepository_);
