...
var BatchJobService = /** @class */ (function (_super) {
    ...
    BatchJobService.prototype.retrieve = function (batchJobId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, batchJobRepo, query, batchJob;
    ...
    BatchJobService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, batchJobRepo, query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
    ...
    BatchJobService.prototype.updateStatus = function (batchJobOrId, status) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var transactionManager, batchJob, _b, entityColumnName, eventType, batchJobRepo;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2:
                        _b = this.batchJobStatusMapToProps.get(status) || {}, entityColumnName = _b.entityColumnName, eventType = _b.eventType;
                        ...
                        batchJobRepo = transactionManager.getCustomRepository(this.batchJobRepository_);
                        return [4 /*yield*/, batchJobRepo.save(batchJob)];
                    case 3:
                        batchJob = _c.sent();
                        batchJob.loadStatus();
                        return [4 /*yield*/, this.eventBus_.withTransaction(transactionManager).emit(eventType, {
                                id: batchJob.id,
                            })];
                    case 4:
                        _c.sent();
