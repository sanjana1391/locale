...
var batch_job_1 = __importDefault(require("../services/batch-job"));
var BatchJobSubscriber = /** @class */ (function () {
    function BatchJobSubscriber(_a) {
        ...
        this.eventBusService_
            .subscribe(batch_job_1.default.Events.CREATED, this.preProcessBatchJob)
            .subscribe(batch_job_1.default.Events.CONFIRMED, this.processBatchJob);
    }
