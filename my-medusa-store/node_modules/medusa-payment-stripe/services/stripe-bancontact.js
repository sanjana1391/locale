...
var BancontactProviderService = /*#__PURE__*/function (_AbstractPaymentServi) {
  _inherits(BancontactProviderService, _AbstractPaymentServi);

  var _super = _createSuper(BancontactProviderService);

  function BancontactProviderService(_ref, options) {
    var _this;
    ...
    _classCallCheck(this, BancontactProviderService);
  ...
  _createClass(BancontactProviderService, [{
    key: "getStatus",
    value: function () {
    ...
    value: function () {
      var _createPayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(cart) {
        ...
        var customer_id, region_id, email, region, currency_code, amount, intentRequest, _customer$metadata, customer, stripeCustomer, _stripeCustomer;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return this.regionService_.withTransaction(this.manager_).retrieve(region_id);

              case 3:
                region = _context5.sent;
                currency_code = region.currency_code;
                _context5.next = 7;
                return this.totalsService_.withTransaction(this.manager_).getTotal(cart);
              ...
              case 7:
                ...
                _context5.next = 12;
                return this.customerService_.withTransaction(this.manager_).retrieve(customer_id);
    ...
    key: "retrievePayment",
    value: function () {
      var _retrievePayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(paymentData) {
    ...
    key: "getPaymentData",
    value: function () {
      var _getPaymentData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(paymentSession) {
    ...
    value: function () {
      var _authorizePayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(paymentSession) {
        var context,
            _args8 = arguments;
    ...
    value: function () {
      var _updatePaymentData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(paymentSessionData, data) {
    ...
    key: "updatePayment",
    value: function () {
      var _updatePayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(paymentSessionData, cart) {
        ...
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 8:
                return _context10.abrupt("return", this.stripe_.paymentIntents.update(paymentSessionData.id, {
    ...
    key: "deletePayment",
    value: function () {
      var _deletePayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(paymentSession) {
    ...
    key: "refundPayment",
    value: function () {
      var _refundPayment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(payment, refundAmount) {
...
_defineProperty(BancontactProviderService, "identifier", "stripe-bancontact");

var _default = BancontactProviderService;
