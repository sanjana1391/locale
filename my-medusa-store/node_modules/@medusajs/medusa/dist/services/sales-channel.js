...
var SalesChannelService = /** @class */ (function (_super) {
    ...
    function SalesChannelService(_a) {
        var salesChannelRepository = _a.salesChannelRepository, eventBusService = _a.eventBusService, manager = _a.manager, storeService = _a.storeService;
        var _this = 
    ...
    SalesChannelService.prototype.retrieve_ = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, salesChannelRepo, _a, relations, query, salesChannel, selectorConstraints;
    ...
    SalesChannelService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, salesChannelRepo, selector_, q, query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
                    ...
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        salesChannelRepo = transactionManager.getCustomRepository(this.salesChannelRepository_);
                                        return [4 /*yield*/, salesChannelRepo.addProducts(salesChannelId, productIds)];
                                    case 1:
                                        _a.sent();
                                        return [4 /*yield*/, this.retrieve(salesChannelId)];
                                    case 2: return [2 /*return*/, _a.sent()];
