...
var StoreService = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        storeRepository = transactionManager.getCustomRepository(this.storeRepository_);
                                        currencyRepository = transactionManager.getCustomRepository(this.currencyRepository_);
    ...
    StoreService.prototype.retrieve = function (config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, storeRepo, query, store;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
                        storeRepo = manager.getCustomRepository(this.storeRepository_);
                        query = (0, utils_1.buildQuery)({}, config);
                        return [4 /*yield*/, storeRepo.findOne(query)];
                    case 1:
                        store = _a.sent();
                        if (!store) {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        storeRepo = transactionManager.getCustomRepository(this.storeRepository_);
                                        currencyRepository = transactionManager.getCustomRepository(this.currencyRepository_);
                                        return [4 /*yield*/, currencyRepository.findOne({
