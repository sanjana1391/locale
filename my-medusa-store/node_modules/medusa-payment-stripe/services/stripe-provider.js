...
var StripeProviderService = /*#__PURE__*/function (_AbstractPaymentServi) {
  _inherits(StripeProviderService, _AbstractPaymentServi);

  var _super = _createSuper(StripeProviderService);

  function StripeProviderService(_ref, options) {
    var _this;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                return _context3.abrupt("return", this.stripe_.customers.retrieve(customerId));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                _context4.next = 7;
                return this.customerService_.withTransaction(this.manager_).update(customer.id, {
                  metadata: {
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.prev = 0;
                return _context6.abrupt("return", this.stripe_.paymentIntents.retrieve(data.id));
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.prev = 0;
                return _context7.abrupt("return", this.stripe_.paymentIntents.retrieve(paymentSession.data.id));
        ...
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 4:
                intent = _context13.sent;
                return _context13.abrupt("return", intent);

              case 8:
                _context13.prev = 8;
                _context13.t0 = _context13["catch"](1);

                if (!(_context13.t0.code === "payment_intent_unexpected_state")) {
                  _context13.next = 13;
                  break;
                }

                if (!(_context13.t0.payment_intent.status === "succeeded")) {
                  _context13.next = 13;
                  break;
                }

                return _context13.abrupt("return", _context13.t0.payment_intent);
