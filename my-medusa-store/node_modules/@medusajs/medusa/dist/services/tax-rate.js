...
var TaxRateService = /** @class */ (function (_super) {
    ...
    function TaxRateService(_a) {
        var manager = _a.manager, productService = _a.productService, productTypeService = _a.productTypeService, shippingOptionService = _a.shippingOptionService, taxRateRepository = _a.taxRateRepository;
    ...
    TaxRateService.prototype.list = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        taxRateRepo = this.manager_.getCustomRepository(this.taxRateRepository_);
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, taxRateRepo.delete(query.where)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
