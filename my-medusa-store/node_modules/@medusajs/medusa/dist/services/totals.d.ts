...
declare type GetShippingMethodTotalsOptions = {
    include_tax?: boolean;
...
declare type LineItemTotalsOptions = {
    include_tax?: boolean;
    use_tax_lines?: boolean;
    exclude_gift_cards?: boolean;
    calculation_context?: TaxCalculationContext;
};
declare type GetLineItemTotalOptions = {
    include_tax?: boolean;
...
declare type CalculationContextOptions = {
    is_return?: boolean;
