...
var NoteService = /** @class */ (function (_super) {
    ...
    function NoteService(_a) {
        var manager = _a.manager, noteRepository = _a.noteRepository, eventBusService = _a.eventBusService;
    ...
    NoteService.prototype.list = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, noteRepo.find(query)];
            });
        });
    };
    /**
                    ...
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        noteRepo = manager.getCustomRepository(this.noteRepository_);
                                        return [4 /*yield*/, this.retrieve(noteId, { relations: ["author"] })];
                                    case 1:
                                        note = _a.sent();
                                        note.value = value;
                                        return [4 /*yield*/, noteRepo.save(note)];
