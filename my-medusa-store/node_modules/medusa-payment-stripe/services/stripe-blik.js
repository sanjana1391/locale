...
var BlikProviderService = /*#__PURE__*/function (_AbstractPaymentServi) {
  _inherits(BlikProviderService, _AbstractPaymentServi);

  var _super = _createSuper(BlikProviderService);

  function BlikProviderService(_ref, options) {
    var _this;
    ...
    _classCallCheck(this, BlikProviderService);
  ...
  _createClass(BlikProviderService, [{
    key: "getStatus",
    value: function () {
...
_defineProperty(BlikProviderService, "identifier", "stripe-blik");

var _default = BlikProviderService;
