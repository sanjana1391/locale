    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(0, utils_1.isDefined)(validated.region_id)) return [3 /*break*/, 1];
            ...
            case 5:
                ...
                return [4 /*yield*/, entityManager.transaction(function (manager) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, cartService.withTransaction(manager).create(toCreate)];
                                case 1:
                                    cart = _a.sent();
                                    if (!validated.items) return [3 /*break*/, 3];
