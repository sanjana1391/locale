...
var GiropayProviderService = /*#__PURE__*/function (_AbstractPaymentServi) {
  _inherits(GiropayProviderService, _AbstractPaymentServi);

  var _super = _createSuper(GiropayProviderService);

  function GiropayProviderService(_ref, options) {
    var _this;
